...
crash_sound= pygame.mixer.Sound("music_6144214533466315_file7d0665438e81d8eceb98c1e31fca80c1.wav")

#pygame.draw.rect(gameDisplay,black,((display_width * 0.36),(display_height * 0.71),car_width ,car_height),0)
...
'''def message_display1(text,count):
    largeText = pygame.font.Font('freesansbold.ttf',85)
...
'''def yourscore(count):
    message_display1('your score is',count)'''


def gameLoop():
    global pause
    pygame.mixer.music.load('nfsringtone.mp3')
    ...
    while gameExit==False:
        ...
        #sky
         ...
         smltree(stx2,sty2)
         smltree(stx3,sty3)
         home(xh,yh)  #home(150,250)
         home1(xh1,yh1)#home1(950,200)
         car(x,y)
        #left trees
         tree(xtree,ytree)  #tree(100,200)
         tree(xtreeA,ytreeA)  #tree(50,250)
         tree(xtreeC,ytreeC)  #tree(1100,200)
         tree1(xtree1,ytree1) #tree1(950,300)
         tree(xtreeB,ytreeB)  #tree(1200,350)
        
         tree1(xtree2,ytree2) #tree1(95,300)
         ...
         #collision=detectCollision(x,y,car_width,car_height,obs1_x,obs1_y,obs1_width,obs1_width) 
